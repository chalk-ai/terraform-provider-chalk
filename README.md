...
`make docs` runs three steps in order:
...
3. **`genchangelog`** — compares the live schema with versioned snapshots and updates `docs/guides/changelog.md`.
