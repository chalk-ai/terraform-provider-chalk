...
var resourcePermissionsMarkdown = map[string]string{
	...
	"chalk_cluster_host_pool":                                     "**Required permissions:** `deploy.create` *(team-scoped)*",
	"chalk_cluster_model_registry_cloud_storage_binding":          "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_cluster_plan_stages_cloud_storage_binding":             "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_cluster_source_bundle_cloud_storage_binding":           "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_cluster_timescale":                                     "**Required permissions:** `team.admin`, `deploy.read`",
	"chalk_cluster_volume_cloud_storage_binding":                  "**Required permissions:** `project.create` *(team-scoped)*",
	...
	"chalk_environment_host_pool":                                 "**Required permissions:** `deploy.create`",
	"chalk_environment_model_registry_cloud_storage_binding":      "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_environment_offline_store_connection_binding":          "**Required permissions:** `deploy.create`, `deploy.read`",
	"chalk_environment_plan_stages_cloud_storage_binding":         "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_environment_source_bundle_cloud_storage_binding":       "**Required permissions:** `project.create` *(team-scoped)*",
	"chalk_gcp_cloud_credentials":                                 "**Required permissions:** `project.create`",
	"chalk_kubernetes_cluster":                                    "**Required permissions:** `project.create` *(team-scoped)*",
